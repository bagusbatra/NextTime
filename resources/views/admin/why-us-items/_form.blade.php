<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div>
        ...
        <x-text-input id="icon" name="icon" type="text" class="mt-1 block w-full"
                      :value="old('icon', $item->icon)" required autofocus placeholder="Contoh: wallet" />
    ...
    <div class="md:col-span-2">
        ...
        <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                      :value="old('title', $item->title)" required placeholder="Contoh: Harga Terjangkau" />
    ...
    <div class="md:col-span-2">
        ...
        <textarea id="description" name="description" rows="3" required
                  class="mt-1 block w-full border-gray-300 focus:border-cyan-500 focus:ring-cyan-500 rounded-md shadow-sm">{{ old('description', $item->description) }}</textarea>
...
<div class="mt-6 flex items-center gap-3">
    ...
    <a href="{{ route('admin.why-us-items.index') }}" class="text-sm text-gray-500 hover:underline">Batal</a>
</div>
